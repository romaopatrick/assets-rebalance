...
{
    public class FinAssetBankAccountsController(FinAssetBankAccountsService service) : AssetsController
    {

        private readonly FinAssetBankAccountsService _service = service;
        [HttpGet("all")]
